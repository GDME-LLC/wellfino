          ...
          >
            ...
            <div className="mt-auto flex items-center justify-between pt-4">
              ...
              <ShopNowButton
                ...
                className="inline-flex items-center gap-1.5 rounded-full bg-primary px-4 py-2 text-xs font-medium text-primary-foreground transition-all group-hover:shadow-md hover:brightness-110"
              >
